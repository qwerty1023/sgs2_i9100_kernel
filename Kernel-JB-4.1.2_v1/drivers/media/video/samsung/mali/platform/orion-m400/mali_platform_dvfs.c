...
mali_dvfs_threshold_table mali_dvfs_threshold[MALI_DVFS_STEPS]={
	/*step 0*/{((int)((255*0)/100))  ,((int)((255*75)/100))}, //0-85
	/*step 1*/{((int)((255*65)/100)) ,((int)((255*85)/100))}, //75-85
	/*step 2*/{((int)((255*75)/100)) ,((int)((255*100)/100))} }; //75-100
...
static unsigned int asv_3d_volt_5_table[ASV_5_LEVEL][MALI_DVFS_STEPS] = {
	...
	{ 900000,  900000, 1000000},	/* A */
	{ 900000,  900000, 1000000},	/* B */
	{ 900000,  900000, 1000000},	/* C */
	{ 900000,  900000,  950000},	/* D */
};

static unsigned int asv_3d_volt_8_table[ASV_8_LEVEL][MALI_DVFS_STEPS] = {
	/* L3 (100/134MHz) L2(160MHz), L1(267MHz) */
	{ 950000,  950000, 1000000},	/* SS */
	{ 900000,  950000, 1000000},	/* A1 */
	{ 900000,  900000,  950000},	/* __A2__ */
	{ 900000,  900000,  950000},	/* B1 */
	{ 900000,  900000,  950000},	/* B2 */
	{ 900000,  900000,  950000},	/* C1 */
	{ 900000,  900000,  950000},	/* C2 */
	{ 900000,  900000,  950000},	/* D1 */
};
#endif
